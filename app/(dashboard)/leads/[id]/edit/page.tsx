    ...
    <div className="p-6 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm">Update company information</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              ...
              <input type="text" name="company_name" value={formData.company_name}
                onChange={handleChange} required placeholder="Tech Corp Pvt Ltd"
            ...
            <div>
              ...
              <input type="text" name="mobile_number" value={formData.mobile_number}
            ...
            <div>
              ...
              <input type="text" name="email" value={formData.email}
                onChange={handleChange} placeholder="contact@techcorp.com"
                className="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Website URL</label>
              <input type="text" name="website_url" value={formData.website_url}
                onChange={handleChange} placeholder="https://techcorp.com"
                className="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none" />
            </div>
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Address</label>
              <textarea name="address" value={formData.address}
                onChange={handleChange} placeholder="123 Business Street, Tech Park, City"
                rows={3}
            ...
            <div>
              ...
              <select name="business_category" value={formData.business_category}
            ...
            <div>
              ...
              <input type="number" name="google_rating" value={formData.google_rating}
                onChange={handleChange} placeholder="4.5" min="0" max="5" step="0.1"
                className="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none" />
            </div>
          </div>
